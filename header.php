...
<head>
    ...
    <link rel="icon"
          href="<?php echo str_replace("http://", "//", get_template_directory_uri()); ?>/dist/img/favicon.ico"
          type="image/x-icon">
    <meta property="og:image"
          content="<?php echo str_replace("http://", "//", get_template_directory_uri()); ?>/dist/img/share.jpg"/>
    <!-- Google Tag Manager -->
    <script>(function (w, d, s, l, i) {
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-KQH9RHZ');</script> <!-- End Google Tag Manager -->
    <!-- Facebook Pixel Code
    ...
    <noscript><img height="1" width="1" src="https://www.facebook.com/tr?id=1687728621260788&ev=PageView&noscript=1"/>
    ...
    <script>        (function (i, s, o, g, r, a, m) {
        ...
        ga('create', 'UA-103956846-1', 'auto');    </script> <?php wp_head(); ?>
    <style>        body.fp-viewing-4 #fp-nav {
...
<noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KQH9RHZ" height="0" width="0"
...
<!--<script>    !function (f, b, e, v, n, t, s) {
    ...
    fbq('track', 'PageView');</script>-->
<noscript><img height="1" width="1" src="https://www.facebook.com/tr?id=1687728621260788&ev=PageView&noscript=1"/>
</noscript><!-- End Facebook Pixel Code --><!--Cookies-->
<style>    .cookies {
        position: fixed;
        bottom: 0;
        left: 0;
...
<div class="cookies" id="cookies"><a href="#" class="close-cookies" onclick="closeCookies();">
        <spa></spa>
    </a>
    <div class="cookies-container"><h3>Política de cookies</h3>
        <p> Usamos os cookies (proprietários e de terceiros) para ajudar você a navegar em nosso website e colher
            informações relacionadas ao uso do próprio website. <br> Ao acessar nossas páginas, você concorda com o uso
            dos cookies. Para mais informações sobre cookies, ou se não concorda com isso, consulte nossa <a
                    href="http://stage.optimumpet.com.br/">Política de Cookies.</a></p></div>
</div>
<script>    function closeCookies() {
...
<header class="header-main active"><a href="<?php echo get_home_url(); ?>" class="logo">
        <svg class="svg-logo" id="b5af54d3-3dc9-4a3c-9e6b-4f907af6ae46" data-name="ARTWORK"
             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 217.86 34.16"><title>Vector Smart Object</title>
