    ...
    var main = {
        ...
        products = {
            init: function () {
                ...
                if ($('.dica').length) {
                    var active_cat = JSON.parse(cat_terms);
                    $(".category_list").each(function () {
                        $(this).text();
                        // console.log(cat_terms);
                        if ($(this).text() == active_cat) {
                            $(this).addClass('active');
                        }
                        if (active_cat[0] == 'Tudo sobre Cachorros' || active_cat[0] == 'Tudo Sobre Gatos') {
                            if ($(this).text() == active_cat[1]) {
                                $(this).addClass('active');
                            }
                        } else {
                            if ($(this).text() == active_cat[0]) {
                                $(this).addClass('active');
                            }
                        }
                        console.log(active_cat[0]);
                    });
                }
            }
        },
