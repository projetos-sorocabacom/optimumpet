<footer class="footer-main">
    <div class="box-1">
        ...
        <div class="social">
            ...
            <a href="https://www.instagram.com/optimumpetbrasil/" target="_blank" title="Instagram"><img src="<?php echo get_template_directory_uri()?>/dist/img/icon-instagram-page-optimum.png" alt="Ícone Instagram - Página Optimum Pet">Optimum Pet</a>
        </div>
    </div>
    ...
    <div class="box-2">
        ...
        <div class="col-1">
            <h3>Tudo sobre Cachorros</h3>

            <?php
                wp_nav_menu(
                    array(
                        'theme_location' => 'footer_sobre_cachorros',
                        'container'      => 'div'
                    )
                );
            ?>
        ...
        <div class="col-1">
            <h3>Tudo sobre Gatos</h3>

            <?php
                wp_nav_menu(
                    array(
                        'theme_location' => 'footer_sobre_gatos',
                        'container'      => 'div'
                    )
                );
            ?>
