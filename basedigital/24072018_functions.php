...
register_nav_menus( array(
	...
	'footer_caes'   => 'Menu rodape caes',
	'footer_sobre_cachorros'   => 'Menu sobre cachorros',
	'footer_gatos'   => 'Menu rodape gatos',
	'footer_sobre_gatos'   => 'Menu sobre gatos',
...
function basedigital_scripts() {
	...
	wp_enqueue_script( 'jquery-fullpage', '//cdnjs.cloudflare.com/ajax/libs/fullPage.js/2.9.5/jquery.fullpage.min.js', array(), '2.9.5', true );
	wp_enqueue_script( 'scrolloverflow', '//cdnjs.cloudflare.com/ajax/libs/fullPage.js/2.9.5/vendors/scrolloverflow.js', array(), '2.9.5', true );
	...
	wp_enqueue_script( 'main-js', '/wp-content/themes/basedigital/dist/js/main.min.js?ver=1.0.0', array(), '1.0.0', true );

	//CSS
	wp_enqueue_style( 'fullpage-css', '//cdnjs.cloudflare.com/ajax/libs/fullPage.js/2.9.5/jquery.fullpage.min.css', array(), '1.8.1' );
	wp_enqueue_style( 'slick-css', '//cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.8.1/slick.css', array(), '1.8.1' );
	wp_enqueue_style( 'main-css', '/wp-content/themes/basedigital/dist/css/main.min.css?ver=1.0', array(), '1.0' );
...
function filter_post() {
	...
	foreach ( $products_list as $product ) {
		$imagem = get_field( "imagem_produto_desktop", $product->ID )['url'];
		$add_product = array(
			"category"     => $_POST["id"],
