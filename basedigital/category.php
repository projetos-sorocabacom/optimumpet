...
$umidos = array(6, 7, 8, 9, 10, 18, 19, 20, 21, 22);
...
if (in_array($actual_category, $secos)) {
    $tipo_alimento = "Ração seca";
} else if (in_array($actual_category, $umidos)) {
    $tipo_alimento = "Ração úmida";
} else {
...
?>
    ...
    <main class="product">
        <h1 class="title-main">Ração para <?php echo $type_animal; ?></h1>
            ...
            <div class="box-filtro">
                ...
                <div class="select-custom show tipo-alimento">
                    ...
                    <ul class="list-option">
                        ...
                        <li>
                            <label>
                                <input type="radio" name="type_food" value="<?php echo $id_todos_umidos; ?>" data-url="<?php echo $link_todos_umido; ?>" data-action="alimento umido" data-category="filtro-tipo" data-label="local-">
                                <span>Ração úmida</span>
                            </label>
                        </li>
                    </ul>
                </div>
