...
$idSlider   = $post->post_name == 'tudo-sobre-cachorros' ? 94 : 92;
$idTaxonomy = $post->post_name == 'tudo-sobre-cachorros' ? 36 : 37;
...
<div class="filtro">
    <div class="container">
        ...
        <button class="clean-filter" data-action-dicas="<?php echo $page; ?>" data-info="limpar-filtro" data-label="<?php echo $item['titulo']; ?>">Limpar filtros</button>
    </div>
</div>
    ...
    <div class="grid">
        ...
        forEach ( $dicas as $dica ) {
            ...
            <div class="grid-item <?php echo $termId; ?>">
                ...
                <a href="<?php echo get_permalink( $dica->ID ); ?>" class="link" data-action-dicas="<?php echo sanitize_title($item['titulo']); ?>" data-info="<?php echo sanitize_title($dica->post_title); ?>" data-label="saiba-mais">Saiba mais ></a>
            </div>
            <?php
        }
        ?>
    ...
    <aside>
        <div class="categories">
            ...
            <?php
                ...
                foreach ( $categorias as $categoria ) {
                    ?>
                        <li data-action-dicas="<?php echo sanitize_title($item['titulo']); ?>" data-info="todas-as-categorias" data-label="<?php echo $categoria->name; ?>">
        ...
        foreach($values as $value)
        {
            ?>
                    <div class="product_related">
                        <figure>
                            <a href="<?php echo get_permalink($value->ID); ?>" data-action="imagem-<?php echo sanitize_title($value->post_title); ?>" data-category="<?php echo get_page_uri( $value->ID ); ?>" data-label="<?php echo sanitize_title($item['titulo']); ?>">
                        ...
                        <a href="<?php echo get_permalink($value->ID); ?>" class="btn-dark white" data-action="conheca-<?php echo sanitize_title($value->post_title); ?>" data-category="<?php echo get_page_uri( $value->ID ); ?>" data-label="<?php echo sanitize_title($item['titulo']); ?>">CONHEÇA</a>
                        
                        <a href="#" class="btn-dark buy" data-action="comprar-<?php echo sanitize_title($value->post_title); ?>" data-category="<?php echo get_page_uri( $value->ID ); ?>" data-label="<?php echo sanitize_title($item['titulo']); ?>" data-cobasi="<?php echo get_field("cobasi", $value->ID); ?>" data-petlove="<?php echo get_field("petlove", $value->ID); ?>" data-petz="<?php echo get_field("petz", $value->ID); ?>" data-produto="<?php echo get_page_uri( $value->ID ); ?>">Comprar</a>
                    </div>
                    <?php
                }
                echo'</div>';
    ...
    <div class="section our-products">
        ...
        <div class="food-box dog">
            ...
            <div class="box-buttons">
                <a href="<?php echo get_category_link( 3 ) ?>" class="btn-dark" data-action-dicas="<?php echo sanitize_title($item['titulo']); ?>" data-info="conheca-produto" data-label="alimento-caes">Alimentos para cães</a>
            </div>
        </div>
        ...
        <div class="food-box cat">
            ...
            <div class="box-buttons">
                <a href="<?php echo get_category_link( 4 ) ?>" class="btn-dark" data-action-dicas="<?php echo sanitize_title($item['titulo']); ?>" data-info="conheca-produto" data-label="alimento-gatos">Alimentos para gatos</a>
            </div>
        </div>
