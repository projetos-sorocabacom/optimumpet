    ...
    <div id="fullpage">
        ...
        <div class="section our-products">
            ...
            <div class="about-box optimum">
                <div class="wrap">
                    <h4>Sobre OPTIMUM™</h4>
                    <p>OPTIMUM™ assumiu um importante compromisso: o aproveitamento máximo do alimento. Com uma receita desenvolvida para garantir uma excelente biodisponibilidade nutricional, ajuda o animal a absorver melhor os nutrientes em cada refeição. Esse compromisso está por trás de nosso selo BIOAVAILABILITY: A garantia Optimum(™) de uma excelente absorção nutricional para que cães e gatos aproveitem o máximo do alimento e desfrutem de cada etapa do seu desenvolvimento com saúde e energia.</p>
