...
function basedigital_scripts() {
    ...
    wp_enqueue_script( 'foundation-equalizer', 'https://cdnjs.cloudflare.com/ajax/libs/foundation/6.5.3/js/plugins/foundation.equalizer.min.js', array('foundation-core'), '1.0.0', true );
    wp_enqueue_script( 'foundation-media-query', 'https://cdnjs.cloudflare.com/ajax/libs/foundation/6.5.3/js/plugins/foundation.util.mediaQuery.min.js', array('foundation-core'), '1.0.0', true );
    ...
    wp_enqueue_script( 'vide', 'https://cdnjs.cloudflare.com/ajax/libs/vide/0.5.1/jquery.vide.min.js', array(), '1', true );
    ...
    wp_enqueue_style( 'main-css', '/wp-content/themes/basedigital/dist/css/main.min.css?ver=1.22', array(), '1.0' );
}
