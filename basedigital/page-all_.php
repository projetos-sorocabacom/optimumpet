    ...
    <div class="section our-products">
        ...
        <div class="food-box dog">
            ...
            <div class="box-buttons">
                <a href="<?php echo get_category_link( 3 ) ?>" class="btn-dark" data-action-dicas="<?php echo $page; ?>" data-info="conheca-produto" data-label="alimento-caes">Alimentos para cães</a>
            </div>
        </div>
        ...
        <div class="food-box cat">
            ...
            <div class="box-buttons">
                <a href="<?php echo get_category_link( 4 ) ?>" class="btn-dark" data-action-dicas="<?php echo $page; ?>" data-info="conheca-produto" data-label="alimento-gatos">Alimentos para gatos</a>
            </div>
        </div>
